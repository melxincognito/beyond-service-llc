              ...
              <Box sx={{ width: "70%" }}>
                <CardContent>
                  ...
                  <Typography>
                    ...
                    to the valley and began studying to get licensed as a
                    general contractor while working as a project manager at a
                    flooring installation company.{" "}
                  </Typography>
                </CardContent>
                <Box display="flex" sx={{ marginLeft: 2.5 }}>
                  <LinkedInIcon onClick={linkedInPageClick} color="secondary" />{" "}
